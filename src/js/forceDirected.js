...
ForceDirectedGraph.prototype = {
  ...
  init: function() {
    ...
    function zoomed() {
      ...
      self.App.panels.forceDirected.nodeGroup.selectAll(".rule").attr("transform", function(d, i) {
          return "translate(" + transform.applyX(d.x) + "," + transform.applyY(d.y) + ")";
      });
      self.App.panels.forceDirected.linkGroup.selectAll(".link").attr("transform", transform);
    }
